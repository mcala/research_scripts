...
LW=4
plot '< head -6 energies.dat | tail -5'  w l ls 1 lw LW title '4 grid',\
  '< head -12 energies.dat | tail -5'  w l ls 2 lw LW title '6 grid',\
  '< head -18 energies.dat | tail -5' w l ls 3 lw LW title '8 grid'
